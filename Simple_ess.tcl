...
$n1 $sink1 $ns connect $tcp0 

$sink1 set tcp1 [new Agent/TCP] 

$ns attach-agent $n0 $tcp1 set ftp1 
...
$ns at 190 "$n1 setdest 70 70 15" proc finish { } { global ns nf tf $ns flush-trace exec 

nam lab3.nam & close $tf exit 0 
